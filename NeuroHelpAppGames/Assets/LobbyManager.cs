...
public class LobbyManager : MonoBehaviour
{
    ...
    private IEnumerator LoadImage(string _photoUrl)
    {
        ...
        if (request.error !=null)
        {
            ...
            {
                output = "Tipo de imagen no soportado. Porfavor prueba de nuevo con otra imagen";
            }
    ...
    public void ChangePfpSucces()
    {
        ClearUI();
        actionSuccessPanelUI.SetActive(true);
        actionSuccessText.text = "Imagen de Perfil cambiada satisfactoriamente";
    }
